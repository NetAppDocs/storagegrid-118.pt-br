...
10 segundos por nó ou alguns minutos para toda a grade
 a| 
A atualização do StorageGRID 11,7 para o 11,8 não requer uma atualização do banco de dados Cassandra; no entanto, o serviço Cassandra será interrompido e reiniciado em cada nó de armazenamento.
...
== Exemplo: Tempo estimado para atualizar para o StorageGRID 11,8
...
+
Você deve permitir até 17 horas para concluir a atualização do seu sistema para o StorageGRID 11,8.0.
