...
+
.. Selecione *SUPPORT* > *Tools* > *Grid topology*.
.. Expanda o site e selecione *_grid_node_*.
.. Selecione *SSM* e depois *Eventos* > *Configuração*.
...
. Efetue login no nó selecionado como "admin" usando SSH e alterne para o usuário root local.
