...
.Sobre esta tarefa
Você pode identificar nós desconetados procurando por ícones desconhecidos (azul) ou administrativamente para baixo (cinza) na coluna *Saúde*. No exemplo, o nó de arquivo chamado DC1-ARC1 é desconetado.
...
+
link:grid-node-recovery-procedures.html["Procedimentos de recuperação do nó de grade"]Consulte para obter instruções.
