...
---
= Renomear grade, sites e nós: Visão geral
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* * Tipo de nó*: Os nomes de nó normalmente indicam o tipo do nó. Você pode usar abreviações como `s`, `adm`, `gw` e `arc` (nó de storage, nó de administrador, nó de gateway e nó de arquivamento).
