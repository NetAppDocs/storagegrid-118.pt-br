...
+
Depois que os metadados e os dados do objeto forem recuperados, o suporte técnico usará procedimentos padrão para recuperar nós de Gateway com falha, nós de administração não primários ou nós de arquivamento.
