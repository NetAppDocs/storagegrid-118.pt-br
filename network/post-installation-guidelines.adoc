...
CAUTION: Os nós reiniciam quando seus endereços IP são alterados, o que pode causar interrupções se uma alteração de endereço DHCP afetar vários nós ao mesmo tempo.
