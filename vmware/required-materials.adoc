...
--
Migração de nós (se necessário):: Entenda o link:../swnodes/node-container-migration-requirements.html["requisitos para migração de nós"] procedimento, caso queira realizar manutenção programada em hosts físicos sem interrupção de serviço.
